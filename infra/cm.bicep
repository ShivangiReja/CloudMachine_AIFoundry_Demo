...
resource cm_storage_1_StorageBlobDataContributor 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid('cm_storage', 'cm1afad70ff42d496', principalId, subscriptionResourceId('Microsoft.Authorization/roleDefinitions', 'ba92f5b4-2d11-453d-a403-e96b0029c9fe'))
  properties: {
...
resource cm_storage_1_StorageTableDataContributor 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid('cm_storage', 'cm1afad70ff42d496', principalId, subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '0a9a7e1f-b9d0-4cc4-a60d-0319b160aaa3'))
  properties: {
    principalId: principalId
...
resource cm_servicebus_1_AzureServiceBusDataOwner 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid('cm_servicebus', 'cm1afad70ff42d496', principalId, subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '090c5cfd-751d-490a-894a-3ce6f1109419'))
  properties: {
    principalId: principalId
...
resource cm_eventgrid_subscription_blob 'Microsoft.EventGrid/systemTopics/eventSubscriptions@2022-06-15' = {
  ...
  dependsOn: [
    cm_servicebus_cm1afad70ff42d496_role
  ]
}

resource cm_servicebus_cm1afad70ff42d496_role 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
...
resource openai 'Microsoft.CognitiveServices/accounts@2024-10-01' = {
  ...
  kind: 'OpenAI'
  properties: {
    customSubDomainName: 'cm1afad70ff42d496'
...
resource openai_1_CognitiveServicesOpenAIContributor 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid('openai', 'cm1afad70ff42d496', principalId, subscriptionResourceId('Microsoft.Authorization/roleDefinitions', 'a001fd3d-188f-4b5d-821b-7da978bf7442'))
  properties: {
    principalId: principalId
...
resource openai_cm1afad70ff42d496_chat 'Microsoft.CognitiveServices/accounts/deployments@2024-06-01-preview' = {
  name: 'cm1afad70ff42d496_chat'
  properties: {
    model: {
      format: 'OpenAI'
      name: 'gpt-4o-mini'
